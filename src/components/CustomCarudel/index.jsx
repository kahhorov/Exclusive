...
function CustomCarusel() {
    return (
        <div className='flex !bg-black h-full'>
            <div className="flex flex-col gap-5 w-1/2 p-14">
                ...
                <button className='!text-white underline flex items-center gap-2'>Shop Now <FaArrowRightLong /></button>
            </div>
            <div className="w-1/2 flex items-center justify-center mt-4">
                <img src={HerroImg} alt="Herro img" className='w-[27rem] p-0 m-0' />
            </div>
        </div>
    )
}
